...
namespace Capa_Diseño.Mantenimientos
{
    public partial class Frm_MantProveedores : Form
    {
        ...
        void bloquearTXT()
        {
            TextBox[] txtBox = { Txt_Codigo, Txt_nombre, Txt_direccion, Txt_Telefono, Txt_nit }; //COLOCAR TODOS LOS TEXTBOX QUE SE UTILZIARAN
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "proveedores", Txt_Codigo.Text, Txt_nombre.Text, Txt_direccion.Text, Txt_Telefono.Text, Txt_nit.Text, Cbo_estado.Text };
        ...
        {
            Frm_consultaprovedor curriculum = new Frm_consultaprovedor();
